                ...
                <div className="row d-flex justify-content-center">
                    {
                        state.map((item, index) => {
                            ...
                            return (
                                <>
                                    <Card key={`card${index}`} className="hover01 ml-lg-5 shadow card-catalog d-flex col-lg-3 col-md-5 col-sm-10">
                                        <figure><Card.Img
                    ...
                    <div className="d-flex mb-5 mt-3 justify-content-center">
                        <button type="button" class="btn btn-outline-primary buttonBG font-weight-bold">Show more</button>
                    </div>
                </div>
            </div >
